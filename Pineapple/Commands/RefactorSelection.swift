...
class RefactorSelection: NSObject, XCSourceEditorCommand {
    ...
    private func generatePrompt(_ invocation: XCSourceEditorCommandInvocation, content: String) -> String {
        return "Refactor the following \(getFileType(with: invocation)) source code to make it readable, more optimized, and fix any bugs: \(content). Only generate the code, don't include any other text."
    }
}
